...
Las recetas compatibles con renombres, conversiones, filtros, selección de
columnas y columnas calculadas se ejecutan mediante un plan Polars lazy con el
motor streaming; las operaciones que necesitan validaciones o materialización
completa conservan el camino eager explícito.
