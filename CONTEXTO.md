...
| Versión | `0.151.0`, sincronizada en npm, Cargo y Tauri |
...
| Pruebas observadas | La suite local actual mantiene 274 pruebas frontend y 385 pruebas Rust aprobadas, con 1 benchmark de escala ignorado explícitamente; `perf:benchmark`, `perf:webview2` y `perf:check` pasan con evidencia fresca de 100 MiB, tres corridas sostenidas, dos actualizaciones durables, 819.137 filas WebView2 y cleanup confirmado; E2E y Package históricos pasan en la estación auditada; smoke nativo Win32 y smoke NSIS instalado pasan con cleanup y presupuesto de memoria |
