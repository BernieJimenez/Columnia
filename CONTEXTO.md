...
| `tools/check-ipc-inventory.mjs` / `docs/reference/ipc-inventory.json` | Generan y verifican desde Rust el inventario de 59 comandos de producción, 4 debug y 57 estructuras compartidas; los tests de contrato consumen el inventario. |
