...
| Versión | `0.125.0`, sincronizada en npm, Cargo y Tauri |
...
| Pruebas observadas | La suite local actual mantiene 272 pruebas frontend y suma las regresiones de privacidad, regex, división, guardado, fechas y apertura JSON source-backed a 356 pruebas Rust totales, con 355 aprobadas y 1 ignorada; E2E y Package históricos pasan en la estación auditada; smoke nativo Win32 y smoke NSIS instalado pasan con cleanup y presupuesto de memoria |
