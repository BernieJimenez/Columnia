...
| Última revisión de este documento | 2026-09-22, posterior al commit base `15e4ff6`; documenta el reintento de cancelación y liberación de selecciones pendientes de RV04. `npm run build` pasa; no se ejecutaron pruebas de producto en este corte. La versión vigente es `1.26.0`; RV04 sigue parcial y los gates externos están en `docs/reference/roadmap-current.md`. |
