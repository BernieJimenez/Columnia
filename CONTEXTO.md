...
| 2026-08-24 | P1 completa `schema_contract` en calidad: columnas requeridas, columnas adicionales opcionales, orden requerido, conteos estructurales, migración DataPrep, bridge tipado y editor accesible; integridad referencial, agregados y drift siguen pendientes. | `ROADMAP.md`, `docs/reference/feature-parity.md`, `src-tauri/src/dataset.rs`, `src/bridge.ts`, `src/features/delivery/deliveryModel.ts`, `src/features/delivery/DeliveryPhase.tsx`, `../dataprepv1.1/src/dataprep/core/quality.py` |
