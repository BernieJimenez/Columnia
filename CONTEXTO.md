...
| Versión | `0.63.0`, sincronizada en npm, Cargo y Tauri |
...
| Pruebas observadas | 298 frontend y 354 Rust aprobadas en la suite local actual; E2E y Package históricos pasan en la estación auditada; smoke nativo Win32 y smoke NSIS instalado pasan con cleanup y presupuesto de memoria |
...
| 2026-08-31 | Versión 0.63.0: las consultas DuckDB configuran por operación 512 MB de memoria, un directorio privado de derrame y un límite temporal de 8 GB, con cleanup automático y cancelación preservada para filtros, agregaciones y joins source-backed. | `src-tauri/src/duckdb_query.rs`, `src-tauri/Cargo.toml`, `src-tauri/Cargo.lock`, `CHANGELOG.md`, `ROADMAP.md`, `docs/reference/feature-parity.md` |
