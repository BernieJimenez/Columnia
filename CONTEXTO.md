...
| Pruebas observadas | 285 frontend y 272 Rust aprobadas en la suite local actual; E2E y Package históricos pasan en la estación auditada; smoke nativo Win32 y smoke NSIS instalado pasan con cleanup y presupuesto de memoria |
...
- Las suites locales actuales pasan: 285 tests frontend y 272 tests Rust; los
