...
| Versión | `0.68.0`, sincronizada en npm, Cargo y Tauri |
...
| Pruebas observadas | 298 frontend y 360 Rust aprobadas en la suite local actual; E2E y Package históricos pasan en la estación auditada; smoke nativo Win32 y smoke NSIS instalado pasan con cleanup y presupuesto de memoria |
...
activo. La validación compatible se ejecuta antes por bloques y los demás
formatos, recetas y protecciones mantienen su fallback materializado.
