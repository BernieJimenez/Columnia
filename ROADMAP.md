...
- [ ] **RV16 — Modularización gradual del motor.** Extraer responsabilidades de
  ...
  - **Avance 2026-09-22:** RV16 cuenta con ocho fronteras extraídas desde
    ...
    `dataset/quality_contracts.rs`, resumen categórico en
    ...
    tipos/helpers. Los contratos de reglas conservan la reexportación pública,
    la privacidad de campos y la serialización. También se mantienen la API y
    los límites de muestreo. `cargo check --tests` pasa y la suite Rust completa
