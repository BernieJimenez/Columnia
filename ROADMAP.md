...
- Versión actual del prototipo: `0.94.0`.
...
## 8.1. Cola de ejecución recomendada desde v0.94.0
...
6. **Ejecución lazy/incremental y arranque:** la receta compatible de I1 usa
   ...
   un parseo fijo sin filtros previos. División, ISO y las demás recetas todavía
...
comparación no equivale a ejecución fuera de memoria general. La
  ...
  operaciones generales y el presupuesto integral fuera de RAM. Desde v0.80,
   ...
   División, ISO y operaciones no compatibles conservan materialización.
