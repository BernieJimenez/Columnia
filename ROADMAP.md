...
- [x] Migrar `selected_cleaning_operations` para que los aliases de las limpiezas
  ...
  reproduzcan desde la fuente en el orden fijo; las operaciones sin equivalente
