...
- [ ] **RV16 — Modularización gradual del motor.** Extraer responsabilidades de
  ...
  - **Avance 2026-09-22:** RV16 cuenta con siete fronteras extraídas desde
    ...
    en `dataset/local_query.rs`, estadísticas numéricas y correlaciones eager/
    source-backed en `dataset/numeric_profile.rs`, resumen categórico en
    ...
    tipos/helpers. Se conservan la API, los límites de muestreo y los contratos.
    `cargo check --tests` pasa y la suite Rust completa registra 494 aprobadas,
    0 fallidas y 5 ignoradas (dos benchmarks opt-in y tres integraciones ODBC
    externas). La última matriz incremental del 2026-09-21 pasa 16/16. RV16
    sigue abierta para extracciones graduales.
