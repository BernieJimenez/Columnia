...
- Modularización gradual del motor: 22 módulos concentran 27 responsabilidades
  antes alojadas en `dataset.rs`, manteniendo nombres de comandos, contratos
  JSON y rutas Tauri.
...
| RV16 | En curso | Continuar extrayendo responsabilidades de `dataset.rs` solo al tocar cada área, sin reescritura general ni cambios de contrato. |
