...
- [ ] **RV16 — Modularización gradual del motor.** Extraer responsabilidades de
  ...
  - **Avance 2026-09-22:** RV16 cuenta con veintiún módulos que reúnen veintidós responsabilidades extraídas desde
    ...
    cancelable de `get_dataset_profile`, `dataset/page_reader.rs`, que integra
    `get_dataset_page`, y `dataset/history.rs`, que reúne `HistoryManager` con
