...
| Parsers de CSV, JSON, Parquet y hojas | Corrupción, payloads patológicos, descompresión o consumo excesivo | UTF-8 estricto para texto; validaciones de formato y pruebas funcionales; duplicados normalizados por bloques CPU con huellas compactas y cancelación cooperativa | Los datasets no tienen un tope fijo de tamaño. No hay un presupuesto estricto de RAM/CPU ni análisis adversarial completo por formato; la capacidad depende de los recursos disponibles y de la expansión del formato. |
