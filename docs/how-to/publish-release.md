...
```powershell
npm run updater:verify-published -- --manifest-url https://updates.example/columnia.json --output-dir .local/validation/published-assets/20260828T000000Z --target windows-x86_64 --expected-version 0.92.0
```
