...
Avance RV16 del 2026-09-22: hay treinta y tres módulos con responsabilidades extraídas, entre ellas
...
conflictos y JOIN con cancelación; `dataset/snapshot_comparison.rs` con
