...
La verificación frontend actual pasa `426/426` pruebas en 51 archivos con
`npx vitest run --maxWorkers=1`; `npm run test:e2e` pasa `22/22` y ejecuta el
build de producción. Las regresiones de App reflejan la inspección Excel en dos
llamadas, la carga perezosa de Preparar, el análisis antes de Entregar y los
