...
`dataset/numeric_profile.rs`, `dataset/page_reader.rs` y `dataset/history_contracts.rs`). Los contratos se reexportan desde `dataset.rs` sin cambiar los nombres JSON. El lector nuevo
