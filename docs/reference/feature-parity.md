...
de calidad incremental; las recetas y reglas no incrementales continúan usando
la ruta materializada, mientras `mask`/`hash` se aplican mediante un snapshot
privado intermedio.
