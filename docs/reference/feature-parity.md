...
| Salidas | CSV, JSON, Parquet, SQL, Excel, SQLite, bundle ZIP auditable y entrega ODBC a PostgreSQL/MySQL/SQL Server | Implementada | Streaming remoto source-backed y políticas de esquema más ricas |
