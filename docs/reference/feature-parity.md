...
| Salidas | CSV, JSON, Parquet, SQL, Excel, SQLite, bundle ZIP auditable y entrega ODBC a PostgreSQL/MySQL/SQL Server con transmisión source-backed compatible | Implementada | Políticas de esquema remoto más ricas y streaming para fuentes aún incompatibles |
