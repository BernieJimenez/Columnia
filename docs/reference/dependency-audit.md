...
| `npm run ipc:check` | Aprobado; 60 comandos de producción, 4 debug y 57 estructuras compartidas | El inventario se genera desde `generate_handler!` y se publica en [`ipc-inventory.json`](./ipc-inventory.json); incluye el updater autenticado |
